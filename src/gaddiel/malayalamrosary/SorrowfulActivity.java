...
public class SorrowfulActivity extends Activity {
			...
			public void onClick(final View v) {
	        	...
	        	if(mPlayer!=null && mPlayer.isPlaying()==false)
	        	{
		    		...
		    		System.out.println("--HIT FIRST PLAYING BUTTON--");
		         	mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[0]);
		   	        mPlayer.start();
		       	}
		    	 ...
		    	 if (!exists) {
		     	    ...
		     	    Toast.makeText(SorrowfulActivity.this,"RECORD THE AUDIO FILE", Toast.LENGTH_LONG).show();
		     	}
		    	 else{
	  ...
	  final OnCompletionListener changeStep= new OnCompletionListener(){
	   		...
	   		public void onCompletion(MediaPlayer mp) {
	       	 	if(i<84){
		       		...
		       		if(checkBoxFlag==false)
		       		{
		         	mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[i]);
		   	  ...
		   	  mPlayer.setOnCompletionListener(changeStep);
		     		...
		     		Intent i=new Intent(SorrowfulActivity.this,MainActivity.class);
		            startActivity(i);
		     	}
		     	}
		     };
    		 ...
    		 public void onClick(final View v) {
    			...
    			if(i>7 && i<21){
	  	    	...
	  	    	imageView1=(ImageView)findViewById(R.id.imageView1);
	       		...
	       		if(checkBoxFlag==false)
	       		{
    			mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[20]);
    			mPlayer.start();
			 	i=21;
			 	mPlayer.setOnCompletionListener(changeStep);
	       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK SECOND DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[34]);
	    			mPlayer.start();
				 	i=35;
				 	mPlayer.setOnCompletionListener(changeStep);
		       		}
    				...
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[49]);
	    			mPlayer.start();
	               	i=49;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK FOURTH DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[62]);
	    			mPlayer.start();
	               	i=63;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK FITFTH DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(SorrowfulActivity.this, audioArray[76]);
	    			mPlayer.start();
	               	i=77;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
		 	...
		 	public String findRecordAudio(int[] recordArray,int currentState){
		 		...
		 		File baseDir = Environment.getExternalStorageDirectory();
	       			...
	       			case 7:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Sarrowfulone12" + ".3gp";
	       			...
	       			case 8:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Sarrowfultwo13" + ".3gp";
	       			...
	       			case 9:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Sarrowfulthree14" + ".3gp";
	       			...
	       			case 10:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Sarrowfulfour15" + ".3gp";
	       			...
	       			case 11:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Sarrowfulfive16" + ".3gp";
	       			...
	       			default:
	       				...
	       				mPlayer = MediaPlayer.create(SorrowfulActivity.this, recordArray[i]);
