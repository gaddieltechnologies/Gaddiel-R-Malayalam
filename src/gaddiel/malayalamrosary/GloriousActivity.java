...
public class GloriousActivity extends Activity {
			...
			public void onClick(final View v) {
	        	...
	        	if(mPlayer!=null && mPlayer.isPlaying()==false)
	        	{
		    		...
		    		System.out.println("--HIT FIRST PLAYING BUTTON--");
		         	mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[0]);
		   	        mPlayer.start();
		       	}
		    	 ...
		    	 if (!exists) {
		     	    ...
		     	    Toast.makeText(GloriousActivity.this,"RECORD THE AUDIO FILE", Toast.LENGTH_LONG).show();
		     	}
		    	 else{
	  ...
	  final OnCompletionListener changeStep= new OnCompletionListener(){
	   		...
	   		public void onCompletion(MediaPlayer mp) {
	       		if(i<84){
		       		...
		       		if(checkBoxFlag==false)
		       		{
		         	mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[i]);
		   	  ...
		   	  mPlayer.setOnCompletionListener(changeStep);
		     		...
		     		Intent i=new Intent(GloriousActivity.this,MainActivity.class);
		            startActivity(i);
		     	}
		     	}
	     };
    		 ...
    		 public void onClick(final View v) {
    			...
    			if(i>7 && i<21){
	  	    	...
	  	    	imageView1=(ImageView)findViewById(R.id.imageView1);
	       		...
	       		if(checkBoxFlag==false)
	       		{
    			mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[20]);
    			mPlayer.start();
			 	i=21;
			 	mPlayer.setOnCompletionListener(changeStep);
	       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK SECOND DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[34]);
	    			mPlayer.start();
				 	i=35;
				 	mPlayer.setOnCompletionListener(changeStep);
		       		}
    				...
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[49]);
	    			mPlayer.start();
	               	i=49;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK FOURTH DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[62]);
	    			mPlayer.start();
	               	i=63;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
    			...
    			//	Toast.makeText(rosaryActivity.this,"--HIT ONCLICK FITFTH DECADE----"+i, Toast.LENGTH_LONG).show();
    				imageView1=(ImageView)findViewById(R.id.imageView1);
		       		...
		       		if(checkBoxFlag==false)
		       		{
	    			mPlayer = MediaPlayer.create(GloriousActivity.this, audioArray[76]);
	    			mPlayer.start();
	               	i=77;
	               	mPlayer.setOnCompletionListener(changeStep);
		       		}
		 	...
		 	public String findRecordAudio(int[] recordArray,int currentState){
		 		...
		 		File baseDir = Environment.getExternalStorageDirectory();
	       			...
	       			case 7:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Gloriousone17" + ".3gp";
	       			...
	       			case 8:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Glorioustwo18" + ".3gp";
	       			...
	       			case 9:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Gloriousthree19" + ".3gp";
	       			...
	       			case 10:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Gloriousfour20" + ".3gp";
	       			...
	       			case 11:
	       				...
	       				audioPath = baseDir.getAbsolutePath() + "/RossaryAudio"+"/Gloriousfive21" + ".3gp";
	       			...
	       			default:
	       				...
	       				mPlayer = MediaPlayer.create(GloriousActivity.this, recordArray[i]);
